...
import com.netappsid.mod.ejb3.xml.PersistenceUnitUtils;
...
public class PersistenceUnitUtilsTest
{
	...
	public void testXsltExtention()
	{
		...
		Multimap<String, URL> xsltResourcesByPersistenceUnit = PersistenceUnitUtils.getXsltResourcesByPersistenceUnit(extensionRegistry, bundleContext);
